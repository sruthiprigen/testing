...
<div class="edit-profile">
 ...
 <h2><span><font color="#FB3C04"><center><strong>JobSeeker List</strong></center></font> </a></span></h2> 
...
?>
            ...
            <tr>
			<td ><?php echo $ar['JobSeekId'];?></td>
			<td><?php echo $ar['JobSeekerName'];?></td>
			<td><?php echo $ar['City'];?></td>
			
			
			<td><a href="View_All_User.php?JobSeekId=<?php echo $ar['JobSeekId'];?>"><input type="button" name="sub" value="View" class="form-control btn btn-default" style="width:70px;"> </a></td>
			</tr>
