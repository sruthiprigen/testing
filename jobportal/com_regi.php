...
<li ><a href="#"> </a></li>
<li><a href="index_company.php">All Companies</a></li>
<li><a href="#"></a></li>
...
<h1><span><a href="#">Login</a></span></h1>
</div>
<div class="col-md-6 text-right">
<div class="bread">
<ol class="breadcrumb">
...
<div class="shop-cart">
     <form method="post" onSubmit="return validateForm(this,arrFormValidation);" enctype="multipart/form-data" id="form2">
		<h2><span><font color="#FB3C04"><center><strong>Registration Form</strong></center></font> </a></span></h2>
                  <table width="50%" height="484"  align="center">
                    ...
                    <tr>
                      ...
                      <td><span id="sprytextfield8">
                        <label>
                        <input type="text"  class="form-control" name="txtPerson" id="txtPerson" />
                        </label>
					...
					<td>Area of Work </td>
                      <td><span id="sprytextfield7">
                        <label>
                        <input type="text"  class="form-control" name="txtAreaWork" id="txtAreaWork" />
                        </label>
                    ...
                    <td><span id="sprytextfield10">
                     ...
                     <tr><td></td><td>  <input type="submit" class="form-control btn btn-default" style="width:70px;" name="sub" id="sub" value="Submit" /></td></tr>
                        </div>
...
if(isset($_POST['sub']))
{
$ins="insert into Employer_Reg values('null','".$_POST['txtName']."','".$_POST['txtPerson']."','".$_POST['txtAddress']."','".$_POST['txtCity']."',
'".$_POST['txtEmail']."','".$_POST['txtMobile']."','".$_POST['txtAreaWork']."','pending',
'".$_POST['txtUserName']."','".$_POST['txtPassword']."')";
mysql_query($ins);
echo '<script type="text/javascript">alert("Registration Completed Succesfully");window.location=\'com_login.php\';</script>';
