...
<ol class="breadcrumb">
<li><a href="#">Home</a></li>
<li class="active">Rejected Company </li>
</ol>
</div>
</div>
</div>
...
<div class="edit-profile">
 ...
 <h2><span><font color="#FB3C04"><center><strong>Rejected Company List</strong></center></font> </a></span></h2> 
...
mysql_select_db("project",$con);
 $sel="select * from Employer_Reg Where Status='Reject'";
$res=mysql_query($sel);
