...
<div class="edit-profile">
 ...
 <h2><span><font color="#FB3C04"><center><strong>Company List</strong></center></font> </a></span></h2> 
...
?>
			...
			<td><a href="View_All_Companies.php?EmployerId=<?php echo $ar['EmployerId'];?>&Status=<?php echo $ar['Status'];?>"><input type="button" name="sub" value="View" class="form-control btn btn-default" style="width:70px;">  </a></td>
			</tr>
