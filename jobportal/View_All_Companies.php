...
$sel = "select * from Employer_Reg where EmployerId='".$EmployerId."'";
$res=mysql_query($sel);
while($ar=mysql_fetch_array($res))
{

?>
						<h2><span><a href="#"><center><font color="#FB3C04"><strong>Company Information</strong></font></center></a></span></h2>
...
<center>
                      ...
                      <input type="submit" name="sub" id="sub" value="Approve"class="form-control btn btn-default" style="width:100px;" />
...
{
$Status="Approve";
$o="Update Employer_Reg  set Status='".$Status."' where EmployerId='".$EmployerId."'";

				
	
mysql_query($o);	
echo '<script type="text/javascript">alert("Approve Succesfully");window.location=\'All_Companies.php\';</script>';
...
mysql_query($o);	
echo '<script type="text/javascript">alert("Reject Succesfully");window.location=\'All_Companies.php\';</script>';
