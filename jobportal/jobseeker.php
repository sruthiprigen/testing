...
<center>
 <h2><span><font color="#FB3C04"><center><strong>JobSeeker Login</strong></center></font> </a></span></h2>
</center>
...
<tr><td></td><td></td><td><input type="submit" class="form-control btn btn-default" style="width:70px;" name="sub" value="Login" style="width:70px;" /></td></tr>

</table>
<p align="center"><a href="JobSeekerReg.php"><strong>Create an account</strong></a></p>
</div>
</center>
...
if(isset($_POST['sub']))
{
$d="select * from jobseeker_reg where username='".$_POST['a1']."' and password='".$_POST['a2']."'";
$res=mysql_query($d);
if($ar=mysql_fetch_array($res))
 {
$_SESSION['ID']=$ar['JobSeekId'];
$_SESSION['Name']=$ar['JobSeekerName'];
