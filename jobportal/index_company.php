...
<h1><span><a href="#">All Company</a></span></h1>
</div>
<div class="col-md-6 text-right">
<div class="bread">
<ol class="breadcrumb">
...
<div class="shop-cart">
 ...
 <h2><span><font color="#FB3C04"><center><strong>All Company List</strong></center></font> </a></span></h2> 
...
?>
			...
			<td><a href="index_view_company.php?EmployerId=<?php echo $ar['EmployerId'];?>&Status=<?php echo $ar['Status'];?>"><input type="button" name="sub" value="View" class="form-control btn btn-default" style="width:70px;">  </a></td>
			</tr>
