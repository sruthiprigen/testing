...
<div class="edit-profile">
						...
						<h1><font color="#FB3C04"><center><strong>Application</strong></center></font></h1>
						<form method="post">
...
<table class="table table-bordered" cellpadding="30px" cellspacing="0" align="center">
                       ...
                       <td width="36%"><label><strong>Select Job Title</strong></label></td>
                       
					     <?php
						 
$con=mysql_connect("localhost","root","");
mysql_select_db("project",$con);
$sel="select distinct JobTitle from job_master ";
$res=mysql_query($sel);
...
?>
                     ...
                     <td width="34%">
                        <input type="submit" class="form-control btn btn-default" style="width:70px;" name="sub" id="sub" value="View " />
                      </label></td>
                    </tr>
          </table>
        </form>
...
<table class="table table-bordered" cellpadding="30px" cellspacing="0" align="center">
                  <tr>
                     <td height="68"><strong>JobId</strong></td>
                  ...
                  <?php
					   ...
					   $con=mysql_connect("localhost","root","");
mysql_select_db("project",$con);
$sel="select * from job_Master Where JobTitle='".$Title."'"; 
$res=mysql_query($sel);
while($ar=mysql_fetch_array($res))
{
?>   
                         ...
                         <tr>
						   <td height="115"><strong><?php echo $ar['JobId']; ?></strong></td>
						   <td><strong><?php echo $ar['CompanyName']; ?></strong></td>
						   <td><strong><?php echo $ar['JobTitle']; ?></strong></td>
						    <td><strong><?php echo $ar['Vacancy']; ?></strong></td>
							<td><strong><?php echo $ar['MinQualification']; ?></strong></td>
							<td><strong><?php echo $ar['Description']; ?></strong></td>
							<td><a  href="Apply.php?JobId=<?php echo $ar['JobId'];?> & JobTitle=<?php echo $ar['JobTitle'];?> "><strong><input type="button" name="sub" value="Apply" class="form-control btn btn-default" style="width:70px;"> </a></td>
               <?php
}
