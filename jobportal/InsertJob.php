...
<table width="62%" align="center" cellpadding="30px" cellspacing="0" class="table table-bordered">
                      <tr>
                          <td width="25%"><strong>Job Title</strong></td>
                        ...
                        <tr>
                          ...
                          <td><span id="sprytextarea1">
                            <label>
                            <textarea name="txtDesc" class="form-control" id="txtDesc" cols="25" rows="3"></textarea>
                            </label>
...
$ins = "insert into job_master values('null','".$Name."','".$_POST['txtTitle']."','".$_POST['txtTotal']."','".$_POST['cmbQual']."','".$_POST['txtDesc']."')";
mysql_query($ins);
echo '<script type="text/javascript">alert("Job Inserted Succesfully");window.location=\'Employer_home.php\';</script>';
}
