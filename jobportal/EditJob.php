...
$sel="select * from job_Master  where JobId='".$ID."'";
$res=mysql_query($sel);
...
?>   
                    <table width="78%" align="center" cellpadding="40px" cellspacing="0" class="table table-bordered">
                          ...
                          <td><span id="sprytextfield1">
                            <label>
                            <input type="text" class="form-control" name="txtTitle" id="txtTitle" value=" <?php echo $ar['JobTitle'];?>" /></label>
                        ...
                        <tr>
                          ...
                          <td><span id="sprytextfield2">
                            <label>
                            <input type="text" class="form-control" name="txtTotal" id="txtTotal"  value="<?php echo $ar['Vacancy'];?>"/></label>
                          <span class="textfieldRequiredMsg">A value is required.</span></span>
                            </td>
                        </tr>
                        <tr>
                          <td><strong>Qualification</strong></td>
                          <td width="79%"><select name="cmbQual" id="cmbQual" >
						   <option value="<?php echo $ar['MinQualification'];?>"><?php echo $ar['MinQualification'];?></option>
                        ...
                        <tr>
                          ...
                          <td><span id="sprytextarea1">
                            <label>
                            <textarea name="txtDesc" class="form-control" id="txtDesc" cols="25" rows="3"><?php echo $ar['Description'];?></textarea></label>
                          <span class="textfieldRequiredMsg">A value is required.</span></span>
                            </label>
                          </td>
                        </tr>
                        ...
                        <tr>
                          <td height="85">&nbsp;</td>
                          <td><label>
                            <input type="submit"  name="sub" id="sub" value="Submit"  class="form-control btn btn-default" style="width:70px;"/>
                          </label></td>
                        </tr>
                  </table>
                          <?php
...
$o="Update job_Master  set JobTitle='".$_POST['txtTitle']."',Vacancy='".$_POST['txtTotal']."',MinQualification='".$_POST['cmbQual']."',Description='".$_POST['txtDesc']."'  where JobId='".$ID."'";

mysql_query($o);
echo '<script type="text/javascript">alert("Job  Updated Succesfully");window.location=\'update_job.php\';</script>';
}
