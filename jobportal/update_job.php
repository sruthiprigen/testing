...
<tr>
                        ...
                        <td ><strong><a href="EditJob.php?JobId=<?php echo $ar['JobId'];?>"><input type="button" name="sub" value="Edit" class="form-control btn btn-default" style="width:70px;"></a></strong></td>
                </tr>
