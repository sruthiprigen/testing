...
<div class="edit-profile">
						...
						<h1><font color="#FB3C04"><center><strong>Application Form</strong></center></font></h1>
...
if(isset($_POST['sub']))
{
	...
	$old=$_FILES['txtFile']['tmp_name'];
$new="img/".$_FILES['txtFile']['name'];
move_uploaded_file($old,$new);
		$ins = "insert into application_master values ('null','".$JobSeekId."','".$JobId."','".$JobTitle."','".$Status."','".$_FILES["txtFile"]["name"]."','pending')" ;
