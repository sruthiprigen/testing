...
$sel="select * from job_Master where CompanyName='".$_SESSION['Name']."'";
$res=mysql_query($sel);
...
<tr>
                        <td ><?php echo $ar['JobId'];?></td>
                        <td ><?php echo $ar['JobTitle'];?></td>
                        <td ><?php echo $ar['Vacancy'];?></td>
                        <td ><?php echo $ar['MinQualification'];?></td>
                        <td ><?php echo $ar['Description'];?></td>                      
                        <td ><strong><a href="DeleteJob.php?JobId=<?php echo $ar['JobId'];?>"><input type="button" name="sub" value="Delete" class="form-control btn btn-default" style="width:70px;"></a></strong></td>
                </tr>
