...
<ol class="breadcrumb">
<li><a href="#">Home</a></li>
<li class="active">Approved User</li>
</ol>
</div>
</div>
</div>
...
<div class="edit-profile">
						...
						<h2><span><font color="#FB3C04"><center><strong>Approved Users</strong></center></font> </a></span></h2>
						<table width="83%" align="center" cellpadding="40px" cellspacing="0" class="table table-bordered"> 
					<th ><strong>ApplicationId</strong></th>
                    <th ><strong>JobSeekId</strong></th>
                    <th><strong>JobId</strong></th>
...
$sel="select JobId  from Job_Master where CompanyName='".$Name."'";
$res=mysql_query($sel);
...
$sel="select * from application_master Where Status='Approve' and JobId='".$id."'";
$res=mysql_query($sel);
while($ar=mysql_fetch_array($res))
{
?>
   <tr>
                    ...
                    <td ><strong><?php echo $ar['Status'];?></strong></td>
					  <td ><strong><?php echo $ar['InterviewDate'];?></strong></td>                  </tr>
