...
<table width="78%" align="center" cellpadding="40px" cellspacing="0" class="table table-bordered">
 <tr>
                    <td width="27%"><strong>Jobseeker ID</strong></td>
                   
                    <td width="61%"><?php echo $ar['JobSeekId'];?></td>
                </tr>
              ...
              <p align="center"> <a href="EditProfile_user.php?JobSeekId=<?php echo $ar['JobSeekId'];?>"><strong>Edit Profile</strong></a></p>
