...
<div class="edit-profile">
 ...
 <form id="form1" method="post" action="#">
                       ...
                       <td><label><strong>Select Job Title</strong></label></td>
...
$sel="select  distinct JobId,JobTitle from job_master where CompanyName='".$_SESSION['Name']."'";
$res=mysql_query($sel);
...
$id=$ar['JobId'];
?>
                          <option value="<?php echo $ar['JobTitle']?>"><?php echo $ar['JobTitle']?></option>
						  <?php 
						  } 
						  ?>
                     ...
                     <td>
                        <input type="submit" name="sub" id="sub" value="View "class="form-control btn btn-default" style="width:70px;" />
                      </label></td>
                    </tr>
                  </table>
              </form>
		   ...
		   <br />
                  ...
                  <tr>
                    ...
                    <th ><strong>JobSeekId</strong></div></th>
                    <th><strong>JobId</strong></div></th>
                    <th ><strong>JobTitle</strong></div></th>
                    <th ><strong>Status</strong></div></th>
					<th><strong>InterviewDate</strong></th>
...
$sel = "select * from application_master Where JobTitle='".$Title."' and JobId='".$id."'";
...
?> 
               <tr>
                    <td ><strong><?php echo $ar['ApplicationId'];?></strong></td>
                    <td ><strong><?php echo $ar['JobSeekId'];?></strong></td>
                    <td ><strong><?php echo $ar['JobId'];?></strong></td>
					<td ><strong><?php echo $ar['JobTitle'];?></strong></td>					
                    <td ><strong><?php echo $ar['Status'];?></strong></td>
					  <td ><strong><?php echo $ar['InterviewDate'];?></strong></td>                  
                     <td ><strong></strong><a href="ViewBiodata.php?JobSeekId=<?php echo $ar['JobSeekId']; ?>&AppId=<?php echo $ar['ApplicationId'];?>&JobId=<?php echo $Title;?>&Status=<?php echo $ar['Status'];?>&InterviewDate=<?php echo $ar['InterviewDate'];?>"><input type="button" name="sub" value="View" class="form-control btn btn-default" style="width:70px;"> </a></strong></td>
                  </tr>
                  <?php
}
