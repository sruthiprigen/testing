...
<div class="edit-profile">
						...
						<h2><span><font color="#FB3C04"><center><strong>Change Password</strong></center></font> </a></span></h2>
						<table width="50%" align="center" cellpadding="40px" cellspacing="0" class="table table-bordered"> 
					<tr>
                      <td width="34%"> Old Password</td>
                      <td width="66%"><label><span id="sprytextfield10">
...
<br />
                    ...
                    <center>  <input type="submit" name="sub" id="sub" value="Submit" class="form-control btn btn-default" style="width:70px;"/>
                    </center>
...
$sel="select Password from employer_reg where EmployerId ='".$ID."'";
$res=mysql_query($sel);
...
$o="Update employer_reg  set Password='$newpass' where EmployerId ='".$ID."'  ";
mysql_query($o);
echo '<script type="text/javascript">alert("Password Updated Succesfully");window.location=\'change_password.php\';</script>';
}
else
{
echo '<script type="text/javascript">alert("old password not matching");window.location=\'change_password.php\';</script>';
}
}
