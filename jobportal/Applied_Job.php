...
<div class="edit-profile">
						...
						<h1><font color="#FB3C04"><center><strong>Applied Job</strong></center></font></h1>
						


<table class="table table-bordered" cellpadding="30px" cellspacing="0" align="center">
						 <tr>
                    <th align="center" ><strong>ApplicationId</strong></th>
                    <th align="center"><strong>JobSeekId</strong></div></th>
                    <th align="center"><strong>JobId</strong></div></th>
                    <th align="center"><strong>JobTitle</strong></div></th>
                    <th align="center" ><strong>Status</strong></div></th>
					<th align="center"><strong>InterviewDate</strong></th>	
...
$sel="select * from application_master Where JobSeekId='".$JobSeekId."'";
$res=mysql_query($sel);
while($ar=mysql_fetch_array($res))
{
?>
   <tr>
                    <td align="center"><strong><?php echo $ar['ApplicationId'];?></strong></td>
                    <td align="center"><strong><?php echo $ar['JobSeekId'];?></strong></td>
                    <td align="center"><strong><?php echo $ar['JobId'];?></strong></td>
					<td align="center" ><strong><?php echo $ar['JobTitle'];?></strong></td>					
                    <td align="center"><strong><?php echo $ar['Status'];?></strong></td>
					  <td align="center" ><strong><?php echo $ar['InterviewDate'];?></strong></td>
					  <td align="center"><strong><a href="Delete_Applied_Job.php?ApplicationId=<?php echo $ar['ApplicationId'];?>"  /><input type="button" name="sub" value="Delete" class="form-control btn btn-default" style="width:70px;"></a></strong></td>	                  
					  </tr>
					  <?php
					  }
					  ?>
