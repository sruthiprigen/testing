...
<table class="table table-bordered">
                    <tr>
                    <td width="31%"><strong>Company ID</strong></td>
                    
                    <td width="55%"><?php echo $ar['EmployerId'];?></td>
                  </tr>
					<tr>
		...
		<center><a href="EditProfile.php?EmployerId=<?php echo $ar['EmployerId']; ?>"><font color="#0066FF"><input type="button" name="sub" value="Edit Profile" class="form-control btn btn-default" style="width:150px;align:center;"></font></a></center>
                  </tr>
		  <?php
}
?>		
