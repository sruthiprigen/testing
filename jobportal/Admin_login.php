...
<form method="post" enctype="multipart/form-data">
	...
	<h1><font color="#FB3C04"><center><strong>Admin Login</strong></center></font></h1>
...
<tr><td></td><td></td><td><input type="submit" name="sub" value="Login" class="form-control btn btn-default" style="width:70px;" /></td></tr>
</table>
</div>
</center>
...
if(isset($_POST['sub']))
{
$d="select * from Admin_Master where username='".$_POST['a1']."' and password='".$_POST['a2']."'";
$res=mysql_query($d);
if($ar=mysql_fetch_array($res))
 {
 $_SESSION['ID']=$ar['UserId'];
