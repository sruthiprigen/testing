...
<tr>
                    <td>&nbsp;</td>
                    <td><label>
                      <input type="submit" name="sub" id="sub" class="form-control btn btn-default" style="width:70px;" value="Submit" />
                    </label></td>
                  </tr>
</table>
<?php
...
$sel="select Password from JobSeeker_Reg  where JobSeekId='".$ID."'";
$res=mysql_query($sel);
...
$o="Update JobSeeker_Reg  set Password='$newpass'  where JobSeekId='".$ID."'  ";
mysql_query($o);
echo '<script type="text/javascript">alert("Password Updated Succesfully");window.location=\'change_password_user.php\';</script>';
}
else
{
