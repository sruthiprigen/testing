...
<ol class="breadcrumb">
<li><a href="#">Home</a></li>
<li class="active">Company Login</li>
</ol>
</div>
</div>
</div>
...
<h2><span><font color="#FB3C04"><center><strong>Company Login</strong></center></font> </a></span></h2>
<table height="160" align="center" >
<tr><td width="57">Username</td>
<td width="22"></td>
<td width="158"><input type="text" name="a1" /></td></tr>
<tr><td>Password</td><td></td><td><input type="password" name="a2" /></td></tr>
<tr><td></td><td></td><td><input type="submit" name="sub" value="Login" style="width:70px;" class="form-control btn btn-default" /></td></tr>


</table>
<p align="center"><a href="com_regi.php"><strong><center>Create an account</center></strong></a></p>
...
if(isset($_POST['sub']))
{
$d="select * from employer_reg where username='".$_POST['a1']."' and password='".$_POST['a2']."'";
$res=mysql_query($d);
if($ar=mysql_fetch_array($res))
 {
 $_SESSION['ID']=$ar['EmployerId'];
 $_SESSION['Name']=$ar['CompanyName'];
